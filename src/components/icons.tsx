...
export function EditIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      width="14"
      height="14"
...
export function MinusIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      width="11"
      height="3"
...
export function ReplyIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      width="14"
      height="13"
